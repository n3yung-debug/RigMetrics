...
namespace RigMetrics.Core.Storage;
...
public sealed class SessionStore
{
    ...
    /// <summary>Default per-user location: %AppData%/RigMetrics/sessions.</summary>
    public static SessionStore CreateDefault()
    {
        var baseDir = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
        return new SessionStore(Path.Combine(baseDir, "RigMetrics", "sessions"));
    }
